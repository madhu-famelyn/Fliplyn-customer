export const getUserDetails = async (userId, token) => {
  const res = await fetch(`https://fliplyn-api.onrender.com/admin/${userId}`, {
...
export const createManager = async (data, token) => {
  try {
    const res = await fetch('https://fliplyn-api.onrender.com/managers/', {
      method: 'POST',
      headers: {
...
export const fetchManagersByBuilding = async (buildingId, token) => {
  const res = await fetch(`https://fliplyn-api.onrender.com/managers/building/${buildingId}`, {
    headers: { Authorization: `Bearer ${token}` }
  });
...
export const deleteManager = async (managerId, token) => {
  const res = await fetch(`https://fliplyn-api.onrender.com/managers/${managerId}`, {
    method: 'DELETE',
    headers: { Authorization: `Bearer ${token}` }
  });
